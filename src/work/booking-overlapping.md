...
eyebrow: "BOOKING.COM"
title: "Reducing Overlapping Bookings by Understanding User Triggers"
...
<figure class="case-study-image">
  <img src="/images/overlapping-bookings-process-intro.jpg" alt="Pinned bookings on search results helping users compare existing reservations against new options">
  <figcaption>Regular user research and interviews, a full UX audit and customer journeys helped us tackle this problem strategically across the entire booking process.</figcaption>
</figure>
...
<figure class="case-study-image">
  <img src="/images/personas-keepers-vs-replacers.jpg" alt="Two core personas: Keepers who hold multiple bookings to compare, and Replacers who book, cancel, and rebook repeatedly">
...
<figure class="case-study-image">
  <img src="/images/reassurance-replacers.jpg" alt="Designed moments of reassurance to ease anxiety and boost confidence, reducing the amount of overlapping bookings booked">
  <figcaption>Based on our data and interviews, we found that users often ended up with bookings almost identical in quality to their first. So we designed moments of reassurance in our flow to address these users greatest pain points (e.g. price, quality, location).</figcaption>
</figure>

---

<div class="case-study-callout">
<div class="case-study-callout-content">
...
<figure class="case-study-image">
  <img src="/images/book-and-cancel-desktop.jpg" alt="Design iterations for the cancel-while-booking feature, from early explorations to the final shipped version">
